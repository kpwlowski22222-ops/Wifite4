...
- [Wi-Fi Capabilities](#-wifi-capabilities)
...
| **Domain-specific models** | Wi-Fi, BLE, OSINT, post-exploit each use specialized models |
...
|---------------|-------------|-------------|
| **Wi-Fi** | Scan → target → one-click / AIO / AI chain; MT7922/`mt7921e` injection; deauth, evil twin, PMKID, WPA3, Wi-Fi 6/7 | 80+ attack modules + 60 extended 802.11 modules |
...
| **Wi-Fi Attack Engine** | `core/wifi_attack/` + `core/extended_wifi/` | 140+ Wi-Fi attack/scan modules |
...
| **Scanners** | `core/scanners/` | Wi-Fi, BLE, and Kismet scan backends |
...
|--------|-------|---------|
| **Wi-Fi / BLE** | `xploiter/pentester:latest` | Wireless-specific attack reasoning |
...
| `test_wifi_screen_actions.py` | Wi-Fi TUI actions |
...
| `test_wifi_radio.py` | Wi-Fi radio control |
